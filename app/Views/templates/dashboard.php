...
<html lang="en-GB" data-bs-theme="dark">
    <head>
        ...
        <!-- RSS Feed -->
        <link rel="alternate" type="application/rss+xml" title="<?= esc(config('App')->siteName) ?>" href="<?= site_url('/feed/rss') ?>">
        <!-- Stylesheets Remote -->
                ...
                <div class="offcanvas-body p-0 d-flex flex-column">
                    <nav class="flex-grow-1 py-3" aria-label="Sidebar navigation">
                        ...
                        <ul class="nav flex-column mb-3">
                            <li class="nav-item">
                                <a class="nav-link d-flex align-items-center gap-2 text-white-50 px-3 py-2 active" href="/">
                                    <i class="bi bi-bookmarks-fill"></i> Bookmarks
                                </a>
                            </li>
                        </ul>
                        ...
                        <ul class="nav flex-column mb-3">
                            ...
                            <li class="nav-item">
                                <a class="nav-link d-flex align-items-center gap-2 text-white-50 px-3 py-2" href="/admin/bookmark/create">
                                    <i class="bi bi-plus-circle-fill"></i> Add Bookmark
                                </a>
                            </li>
                        </ul>
                        <?php endif; ?>
